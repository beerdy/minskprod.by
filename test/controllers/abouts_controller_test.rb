...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { description: @about.description, image_name: @about.image_name, image_uid: @about.image_uid, slave: @about.slave, sort: @about.sort, title: @about.title, url: @about.url }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { description: @about.description, image_name: @about.image_name, image_uid: @about.image_uid, slave: @about.slave, sort: @about.sort, title: @about.title, url: @about.url }
    assert_redirected_to about_path(assigns(:about))
  end
