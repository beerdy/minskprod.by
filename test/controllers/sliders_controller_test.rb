...
class SlidersControllerTest < ActionController::TestCase
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post :create, slider: { description: @slider.description, image_name: @slider.image_name, image_uid: @slider.image_uid, slave: @slider.slave, sort: @slider.sort, title: @slider.title, url: @slider.url }
    end
  ...
  test "should update slider" do
    patch :update, id: @slider, slider: { description: @slider.description, image_name: @slider.image_name, image_uid: @slider.image_uid, slave: @slider.slave, sort: @slider.sort, title: @slider.title, url: @slider.url }
    assert_redirected_to slider_path(assigns(:slider))
  end
